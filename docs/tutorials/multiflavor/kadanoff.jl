...
#   julia --project=. docs/tutorials/multiflavor/kadanoff.jl
...
function main(t; β=5, δτ=0.1, δt = 0.1, chi=60)
	...
	# 2*norb = 4 impurity bands on the mixed (Kadanoff) contour:
	# imaginary branch (Nτ, δτ) followed by the real branch (Nt, δt)
	...
	# greater/lesser Green's functions for all real-time steps at once
