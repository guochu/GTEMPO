...
cu_cached_Gt_fast(idx0::Int, lattice::RealGrassmannLattice, A::GrassmannMPS, B::Vararg{GrassmannMPS}; c1::Bool=true, c2::Bool=false, kwargs...) = cu_cached_gf_fast(
				idx0, lattice, A, B...; c1=c1, c2=c2, kwargs...)

cu_cached_greater_fast(idx0::Int, lattice::RealGrassmannLattice, A::GrassmannMPS, B::Vararg{GrassmannMPS}; kwargs...) = cu_cached_gf_fast(
	idx0, lattice, A, B...; b1=:+, b2=:+, c1=false, c2=true, kwargs...)
cu_cached_lesser_fast(idx0::Int, lattice::RealGrassmannLattice, A::GrassmannMPS, B::Vararg{GrassmannMPS}; kwargs...) = -cu_cached_gf_fast(
	idx0, lattice, A, B...; b1=:+, b2=:-, c1=false, c2=true, kwargs...)

cu_cached_greater_fast(idx0::Int, lattice::RealGrassmannLattice, N::Int, A::GrassmannMPS, B::Vararg{GrassmannMPS}; kwargs...) = cu_cached_gf_fast(
	idx0, lattice, N, A, B...; b1=:+, b2=:+, c1=false, c2=true, kwargs...)
cu_cached_lesser_fast(idx0::Int, lattice::RealGrassmannLattice, N::Int, A::GrassmannMPS, B::Vararg{GrassmannMPS}; kwargs...) = -cu_cached_gf_fast(
	idx0, lattice, N, A, B...; b1=:+, b2=:-, c1=false, c2=true, kwargs...)


function cu_cached_gf_fast(idx0::Int, lattice::RealGrassmannLattice, A::GrassmannMPS, Bs::Vararg{GrassmannMPS}; kwargs...)
	cu_cached_gf_fast(idx0, lattice, lattice.k, A, Bs...; kwargs...)
end 
