...
DMRG.DMRG1(trunc::TruncationDimCutoff; maxiter::Int=5, tol::Float64=1.0e-12, verbosity::Int=0) = DMRG1(
			D=trunc.D, tolgauge=trunc.ϵ, maxiter=maxiter, tol=tol, verbosity=verbosity)
DMRG.DMRG2(trunc::TruncationDimCutoff; maxiter::Int=5, tol::Float64=1.0e-12, verbosity::Int=0) = DMRG2(
			trunc=trunc, maxiter=maxiter, tol=tol, verbosity=verbosity)
