...
"""
function occupation2(lattice::RealGrassmannLattice1Order, i::Int, A::Union{GrassmannMPS, Vector}, B::Vararg{GrassmannMPS}; kwargs...) 
...
function occupation2(lattice::ImagGrassmannLattice1Order, i::Int, A::Union{GrassmannMPS, Vector}, B::Vararg{GrassmannMPS}; kwargs...) 
    return 1 + Gτ(lattice, i, i, A, B...; c1=true, c2=false, kwargs...)
end


# real-time second order
function occupation2(lattice::RealGrassmannLattice2Order, A::GrassmannMPS, B::Vararg{GrassmannMPS}; kwargs...) 
