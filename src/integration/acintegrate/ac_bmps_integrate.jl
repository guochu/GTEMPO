...
function _ac_integrate(alg::BMPSIntegrate, lattice::AbstractGrassmannLattice, x0::GrassmannMPS, x1::GrassmannMPS, x2::Vararg{GrassmannMPS}; center::Int=pos2pairindex(length(lattice)))
