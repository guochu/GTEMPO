...
function update_pair_left(left::AbstractTensorMap, j::Int, x::Vector, y::Vector; trunc=DefaultIntegrationTruncation)
	posa = 2*j-1
...
function update_pair_right(right::AbstractTensorMap, j::Int, x::Vector, y::Vector; trunc=DefaultIntegrationTruncation)
	posb = 2 * j
