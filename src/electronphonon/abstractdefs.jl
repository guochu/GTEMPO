...
r_RR(psiA::Dense1DTN, psiB::Dense1DTN) = TK.isometry(promote_type(scalartype(psiA), scalartype(psiB)), space_r(psiA), space_r(psiB))
r_RR(psi::Dense1DTN) = r_RR(psi, psi)
l_LL(psiA::Dense1DTN, psiB::Dense1DTN) = TK.isometry(promote_type(scalartype(psiA), scalartype(psiB)), space_l(psiA), space_l(psiB))
