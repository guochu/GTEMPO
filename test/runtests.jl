...
const mixed_grassmann_orderings = [A1A1B1B1_A1A1a1a1B1B1b1b1(), A1B1B1A1_A2B2B2A2A1B1B1A1a1b1b1a1a2b2b2a2()]
const mixed_ac_grassmann_orderings = [A1A1B1B1_A1A1a1a1B1B1b1b1()]
