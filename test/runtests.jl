...
const real_grassmann_orderings = [A1A1a1a1B1B1b1b1(), A1a1B1b1b1B1a1A1(), A2A2A1A1a2a2a1a1B2B2B1B1b2b2b1b1(), A2B2B2A2A1B1B1A1a1b1b1a1a2b2b2a2(), A2A2B2B2A1A1B1B1a1a1b1b1a2a2b2b2()]
...
const mixed_grassmann_orderings = [A1B1B1A1_A2B2B2A2A1B1B1A1a1b1b1a1a2b2b2a2(), A1B1B1A1_A2B2B2A2A1B1B1A1a1b1b1a1a2b2b2a2()]
const mixed_ac_grassmann_orderings = [A1B1B1A1_A2B2B2A2A1B1B1A1a1b1b1a1a2b2b2a2()]
