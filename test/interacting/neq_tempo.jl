...
@testset "TEMPO vs TCMPS: NEQ for single bath" begin
	...
	g₁ = [-im*Gt(lattice, i, 1, mpsK, mpsI, c1=false, c2=true, b1=:+, b2=:+, band=1, Z=Z) for i in 1:lattice.k]
	l₁ = [-im*Gt(lattice, 1, i, mpsK, mpsI, c1=true, c2=false, b1=:-, b2=:+, band=1, Z=Z) for i in 1:lattice.k]

	g₂ = [-im*Gt(lattice, i, 1, mpsK, mpsI, c1=false, c2=true, b1=:+, b2=:+, band=2, Z=Z) for i in 1:lattice.k]
	l₂ = [-im*Gt(lattice, 1, i, mpsK, mpsI, c1=true, c2=false, b1=:-, b2=:+, band=2, Z=Z) for i in 1:lattice.k]
