			...
			for ordering in imag_grassmann_orderings
				...
				for i in 1:lattice.k
					for band in 1:lattice.bands
						g1 = gf(lattice, i, AB, band=band)
						g2 = gf(lattice, i, A, B, band=band)
						@test abs(g1-g2)/abs(g1) < rtol
						g3 = gf(lattice, i, B, A, band=band)
						@test abs(g1-g3)/abs(g1) < rtol

						g1 = gf(lattice, i, ABC, band=band)
						g2 = gf(lattice, i, A, B, C, band=band)
						@test abs(g1-g2)/abs(g1) < rtol
						g3 = gf(lattice, i, C, A, B, band=band)
						@test abs(g1-g3)/abs(g1) < rtol
						g4 = gf(lattice, i, C, AB, band=band)
			...
			for ordering in imag_grassmann_orderings
				...
				for i in 1:lattice.k
					for band in 1:lattice.bands
						...
						g1 = gf(lattice, i, AB, C, band=band)
						g2 = gf(lattice, i, [A, B], C, band=band)
						@test abs(g1-g2)/abs(g1) < rtol
						g3 = gf(lattice, i, [B, A], C, band=band)
						@test abs(g1-g3)/abs(g1) < rtol
					end
				end
			end
	...
	for N in 2:3
		for bands in 1:2
			for ordering in imag_grassmann_orderings
				...
				for i in 1:lattice.k
					for band in 1:lattice.bands
						g1 = gf(lattice, i, AB, CD, band=band, Z=Z1)
						g2 = gf(lattice, i, A, B, C, D, band=band, Z=Z2)
						@test abs(g1-g2)/abs(g1) < rtol
					end
				end
			end
