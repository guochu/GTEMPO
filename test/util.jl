...
spectrum_func2(D=10) = spectrum(ϵ->f(D, ϵ), lb=0, ub=D)
...
# general impurity model constructors (shared by generalimpurity.jl and buildK2.jl)
...
function gIRLM(; μ::Real, J::Real, U::Real)
	...
	t = interaction(1,2,2,1, coeff=U)
	push!(h, t)
	t = interaction(3,2,2,3, coeff=U)
	push!(h, t)
