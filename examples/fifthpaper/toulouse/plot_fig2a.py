...
for (i, dt) in enumerate(all_dt):
	...
	ax[1,0].plot(taus, err_imag, ls='--', color=colors[i], linewidth=linewidth, label=r'mixed, $\delta t=%s$'%(dt))
...
ax[1,0].annotate(r'(b)', xy=(0.1, 0.85),xycoords='axes fraction', fontsize=fontsize)
...
ax[0,1].loglog(all_dt, errs_real, ls='--', color='k', linewidth=linewidth, markersize=markersize, marker='o', markerfacecolor='none')
...
ax[1,1].loglog(all_dt, errs_imag, ls='--', color='k', linewidth=linewidth, markersize=markersize, marker='o', markerfacecolor='none')
