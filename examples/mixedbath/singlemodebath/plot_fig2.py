...
ax[0,0].plot(ts2, gt2.real, ls='--', color='k', linewidth=linewidth, markersize=markersize, markerfacecolor='none', label=r'$\chi=%s$'%(chi))
...
ax[0,1].plot(chis, gt_errs, ls='--', color='c', linewidth=linewidth, marker='o', markersize=markersize, markerfacecolor='none')
...
ax[1,1].plot(chis, lt_errs, ls='--', color='c', linewidth=linewidth, marker='o', markersize=markersize, markerfacecolor='none')
...
plt.savefig('independentbosons2.pdf', bbox_inches='tight')
