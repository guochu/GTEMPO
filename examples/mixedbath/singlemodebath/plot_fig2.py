...
ax[0,0].set_title(r'Keldysh', fontsize=labelsize)
...
ax[2,0].plot(ts2[:-1], nn2.real, ls='--', color=ax3color, linewidth=linewidth2, markersize=markersize, markerfacecolor='none', label=r'$\chi=%s$'%(chi))
...
ax[0,1].plot(ts, gt.real, ls='-', color=ax1color, linewidth=linewidth1, label=r'ED')
ax[0,1].plot(ts2, gt2.real, ls='--', color=ax1color, linewidth=linewidth2, label=r'GTEMPO')
...
ax[0,1].set_title(r'Kadanoff', fontsize=labelsize)
...
ax[1,1].plot(ts, lt.real, ls='-', color=ax1color, linewidth=linewidth1, label=r'ED')
...
ax[2,1].plot(ts, nn.real, ls='-', color=ax3color, linewidth=linewidth1, label=r'ED')
...
ax[0,2].plot(dts, gt_errs, ls='--', color='k', linewidth=linewidth2, marker='o', markersize=markersize, markerfacecolor='none', label=r'Keldysh')
...
ax[0,2].plot(dts, gt_errs, ls=':', color='k', linewidth=linewidth2, marker='^', markersize=markersize, markerfacecolor='none', label=r'Kadanoff')


ax[1,2].plot(dts, lt_errs, ls=':', color='k', linewidth=linewidth2, marker='^', markersize=markersize, markerfacecolor='none')


ax[2,2].plot(dts, nn_errs, ls=':', color='k', linewidth=linewidth2, marker='^', markersize=markersize, markerfacecolor='none')
...
plt.savefig('toy_real_mixed_noint.pdf', bbox_inches='tight')
