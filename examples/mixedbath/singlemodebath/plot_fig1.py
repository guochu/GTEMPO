...
ax[1,0].plot(ts, gt.real, ls='--', color='k', linewidth=linewidth, label=r'ED')
ax[1,1].plot(ts, gt.imag, ls='--', color='k', linewidth=linewidth, label=r'ED')


ts, gt, lt = read_mixed_tempo(beta, Ntau, t, Nt, mu, omega0, alpha0, omega1, alpha1, chi)

ax[1,0].plot(ts, gt.real, ls='--', color='r', linewidth=linewidth, label=r'GTEMPO')
ax[1,1].plot(ts, gt.imag, ls='--', color='r', linewidth=linewidth, label=r'GTEMPO')
