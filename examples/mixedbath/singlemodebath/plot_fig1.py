...
ax[0,2].plot(ts, nn.real, ls='-', color=ax3color, linewidth=linewidth1, label=r'ED')
ax[0,2].plot(ts2[:-1], nn2.real, ls='--', color=ax3color, linewidth=linewidth2, markersize=markersize, markerfacecolor='none', label=r'$\chi=%s$'%(chi))
...
ax[1,0].set_ylabel(r'$\mathcal{E}[G^{>}(t)]$', fontsize=fontsize)
...
ax[1,2].set_ylabel(r'$\mathcal{E}[X(t)]$', fontsize=fontsize)
