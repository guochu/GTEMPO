...
function main_imag(U, ϵ_d=U/2; β=1, N=10, d=3, α=1, chi = 200)
	# ϵ_d = 0.5
	Nτ = N
	δτ = β / Nτ
	println("U=", U, " ϵ_d=", ϵ_d, " β=", β, " N=", N, " d=", d, " α=", α, " chi=", chi)
	...
	mpspath = "data/andersonholstein_int_imaggtempo_beta$(β)_dtau$(δτ)_d$(d)_alpha$(α)_chi$(chi).mps"
	if ispath(mpspath)
