...
def read_imag_tempo(beta, N, mu, omega, alpha, chi=80):
	dt = beta / N
	filename = 'result/holstein_imaggtempo_beta%s_dtau%s_omega0%s_alpha0%s_mu%s_chi%s.json'%(beta, dt, omega, alpha, mu, chi)
