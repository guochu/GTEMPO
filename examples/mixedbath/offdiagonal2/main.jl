...
function main_real(U, ϵ_d=U/2; β=1, t=1, N=100, ω₀=1, α₀=0.5, ω₁=1, α₁=1, chi = 100)
	# ϵ_d = 0.5
	δt=t / N
	println("N=", N, " t=", t, " U=", U, " ϵ_d=", ϵ_d, " β=", β, " ω₀=", ω₀, " α₀=", α₀, " ω₁=", ω₁, " α₁=", α₁, " chi=", chi)
	...
	mpsI1 = systhermalstate!(mpsI1, lattice, exact_model, β=β, δτ=0.001)
	...
	# @time g₃′ = [cached_nn(lattice, i, 1, mpsI1, mpsI2, cache=cache, band=band, b1=:+, b2=:-) for i in 1:N]
