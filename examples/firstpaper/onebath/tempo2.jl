...
function main(β, U)
	...
	g₁[1] = gf(lattice, 1, 1, mpsK, mpsI, c1=false, c2=true, f1=true, f2=true, band=band)
	l₁[1] = gf(lattice, 1, 1, mpsK, mpsI, c1=true, c2=false, f1=false, f2=true, band=band)
	bds[1] = 1
	...
	for k in 2:N+1
		...
		@time g₁[k] = cached_gf(lattice, k, 1, mpsK′, mpsI2, cache=cache, c1=false, c2=true, f1=true, f2=true, band=band)
		@time l₁[k] = cached_gf(lattice, 1, k, mpsK′, mpsI2, cache=cache, c1=true, c2=false, f1=false, f2=true, band=band)
	end
