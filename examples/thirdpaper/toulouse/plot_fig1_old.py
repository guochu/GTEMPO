...
def read_real_tempo(beta, t, mu, dt, order, chi=1024):
...
def read_imag_tempo(beta, mu, dt, order, chi=1024):
	N = round(beta/dt)
...
ts_real_tempo_e6, ns_real_tempo_e6, gf_real_tempo_e6, bds_real_tempo_e6 = read_real_tempo(beta, t, mu, dt, 6)
ax[0,0].plot(ts_real_tempo_e6, gf_real_tempo_e6, ls='--', color=colors[0], linewidth=linewidth, label=r'$\varsigma=10^{-6}$')
...
ax[0,1].plot(ts_real_tempo_e6, bds_real_tempo_e6, ls='--', color=colors[0], linewidth=linewidth, label=r'$\varsigma=10^{-6}$')
ax[0,1].plot(ts_real_tempo_e7, bds_real_tempo_e7, ls='--', color=colors[1], linewidth=linewidth, label=r'$\varsigma=10^{-7}$')
# ax[0,1].plot(ts_real_tempo_e8, bds_real_tempo_e8, ls='--', color=colors[2], linewidth=linewidth, label=r'$\varsigma=10^{-8}$')
print(bds_real_tempo_e7[-1])

ax[0,1].set_ylabel(r'$\chi$', fontsize=fontsize)
...
diff_e6 = gf_real_analytic[1:] - gf_real_tempo_e6
diff_e7 = gf_real_analytic[1:] - gf_real_tempo_e7
# diff_e8 = gf_real_analytic[1:] - gf_real_tempo_e8

ax1.plot(ts_real_tempo_e6, diff_e6, linewidth=linewidth_s, color=colors[0], markersize=markersize_s, markerfacecolor='none', ls='--', label=r'$\varsigma=10^{-6}$')
ax1.plot(ts_real_tempo_e7, diff_e7, linewidth=linewidth_s, color=colors[1], markersize=markersize_s, markerfacecolor='none', ls='--', label=r'$\varsigma=10^{-7}$')
# ax1.plot(ts_real_tempo_e8, diff_e8, linewidth=linewidth_s, color=colors[2], markersize=markersize_s, markerfacecolor='none', ls='--')
...
ts_imag_tempo_e8, gf_imag_tempo_e8, bds_real_tempo_e8 = read_imag_tempo(beta, mu, dt, 8)
ax[1,0].plot(ts_imag_tempo_e8, gf_imag_tempo_e8, ls='--', color=colors[2], linewidth=linewidth, label=r'$\varsigma=10^{-8}$')


ts_imag_tempo_e9, gf_imag_tempo_e9, bds_real_tempo_e9 = read_imag_tempo(beta, mu, dt, 9)
ax[1,0].plot(ts_imag_tempo_e9, gf_imag_tempo_e9, ls='--', color=colors[3], linewidth=linewidth, label=r'$\varsigma=10^{-9}$')

ts_imag_tempo_e10, gf_imag_tempo_e10, bds_real_tempo_e10 = read_imag_tempo(beta, mu, dt, 10)
ax[1,0].plot(ts_imag_tempo_e10, gf_imag_tempo_e10, ls='--', color=colors[4], linewidth=linewidth, label=r'$\varsigma=10^{-10}$')

# print(gf_imag_analytic[:20])
# print(gf_imag_tempo_e10[:20])
